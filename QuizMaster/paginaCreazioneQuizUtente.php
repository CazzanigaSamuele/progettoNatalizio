...
<head>
    ...
    <script>
        function mostraDomande() {
            const numeroDomande = document.getElementById("numDomande").value;
            const contenitoreDomande = document.getElementById("contenitoreDomande");
...
<body>
    ...
    <form action="gestoreCreazioneQuiz.php" method="GET">
        ...
        <input type="text" name="nomeQuiz" id="nomeQuiz" required><br><br>
        ...
        <input type="number" name="numDomande" id="numDomande" min="1" max="10" required onchange="mostraDomande()"><br><br>
